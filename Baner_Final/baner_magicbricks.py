...
dataset = pd.read_csv("Baner_FInal.csv")

rent = dataset.pop("Rent")

model = RandomForestRegressor(n_estimators=511, max_depth=6, random_state=10, max_features='sqrt', min_samples_split=2, min_samples_leaf=1, bootstrap=True)
