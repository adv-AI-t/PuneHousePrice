...
dataset = pd.read_csv("Wakad_final.csv")

rent = dataset.pop("Rent")

model = RandomForestRegressor(n_estimators=155, max_depth=5, random_state=10, max_features='sqrt', min_samples_split=8, min_samples_leaf=1, bootstrap=True)
